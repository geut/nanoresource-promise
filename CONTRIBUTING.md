# Contributing to nanoresource-promise
...
Fork the project [on GitHub](https://github.com/geut/nanoresource-promise) and check out your copy locally.

```bash
$ git clone git@github.com:username/nanoresource-promise.git
$ cd nanoresource-promise
$ npm install
$ git remote add upstream git://github.com/geut/nanoresource-promise.git
```
